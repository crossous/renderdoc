...
echo ============================================================
echo  RenderSocoDoc Win Build + Package  (v%VERSION%)
echo ============================================================

:: ---- Build x86 ----
echo.
echo [1/2] Building x86 Release ...
...
:: Copy x64 outputs (exclude obj, .lib, pymodules, incremental pdb)
